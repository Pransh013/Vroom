...
const Sidebar = () => {
  ...
  return (
    <section className="sticky left-0 flex border-r  border-gray-500 flex-col justify-between bg-foreground h-screen w-fit top-0 p-6 pt-28 text-white max-sm:hidden lg:w-64">
